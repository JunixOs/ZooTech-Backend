...
public class ListarVacunosPaginadoInteractor : IListarVacunosPaginadoInputPort
{
    private readonly IVacunoRepository _repository;
    private readonly IListarVacunosPaginadoOutputPort _output;
    private readonly IFeatureService _features;
    private readonly ITenantContext _tenant;
    private readonly IDateTimeProvider _time;

    public ListarVacunosPaginadoInteractor(
        IVacunoRepository repository,
        IListarVacunosPaginadoOutputPort output,
    ...
    public async Task Handle(ListarVacunosPaginadoCommand cmd)
    {
        ...
        await _output.Ok(new ListarVacunosPaginadoOutput
        {
