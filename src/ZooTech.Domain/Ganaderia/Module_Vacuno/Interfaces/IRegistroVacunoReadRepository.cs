...
public interface IRegistroVacunoReadRepository
{
    ...
    Task<Dictionary<long, string>> ObtenerCodigosVacunoBatchAsync(IEnumerable<long> ids, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<string, string>> ObtenerNombresCatalogoBatchAsync(string tipoCatalogo, IEnumerable<string> codigos, CancellationToken cancellationToken = default);
