...
{
    Task<bool> ExistsVacunoAsync(long id, CancellationToken cancellationToken = default);

    Task<bool> ExistsCeloAsync(long id, CancellationToken cancellationToken = default);

    Task<long> GetOrCreateResponsableByNameAsync(string nombre, CancellationToken cancellationToken = default);
