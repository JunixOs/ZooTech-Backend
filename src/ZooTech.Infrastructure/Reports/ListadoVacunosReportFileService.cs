...
public sealed class ListadoVacunosReportFileService : IListadoVacunosReportFileService
{
        ...
        ReporteVacunoFiltros filtros)
    {
        var rows = new List<IReadOnlyList<string?>>
        {
            ...
            Row("Busqueda", filtros.Q, "Raza", filtros.Raza, "Procedencia", filtros.Procedencia, null),
        ...
        ReporteVacunoFiltros filtros)
    {
        var lines = new List<string>
        {
            ...
            $"Filtros: q={Empty(filtros.Q)} | raza={Empty(filtros.Raza)} | procedencia={Empty(filtros.Procedencia)} | estado={Empty(filtros.Estado)} | aptoPara={Empty(filtros.AptoPara)}",
