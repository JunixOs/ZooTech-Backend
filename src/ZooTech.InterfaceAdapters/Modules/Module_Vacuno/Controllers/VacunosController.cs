...
{
    private readonly IListarVacunosPaginadoInputPort _inputPort;
    private readonly ListarVacunosPaginadoPresenter _presenter;

    public VacunosController(
        IListarVacunosPaginadoInputPort inputPort,
        ListarVacunosPaginadoPresenter presenter)
    {
