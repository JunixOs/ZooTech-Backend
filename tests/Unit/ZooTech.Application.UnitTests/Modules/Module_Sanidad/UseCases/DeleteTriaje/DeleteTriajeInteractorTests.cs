...
public class DeleteTriajeInteractorTests
{
    ...
    public async Task Handle_WhenTriajeExists_SoftDeletesAndUpdates()
    {
        ...
        var interactor = new DeleteTriajeInteractor(_repositoryMock.Object, _dateTimeProviderMock.Object);
        ...
        _repositoryMock.Verify(r => r.UpdateAsync(
            It.Is<Triaje>(t => t.IsDeleted && t.MotivoEliminacion == "Duplicado" && t.DeletedAt == now),
