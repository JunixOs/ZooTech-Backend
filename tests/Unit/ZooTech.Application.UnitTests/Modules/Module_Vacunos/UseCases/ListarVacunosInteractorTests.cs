...
namespace ZooTech.Application.UnitTests.Modules.Module_Vacunos.UseCases;

public class ListarVacunosInteractorTests
{
    private readonly IVacunoRepository _repositoryMock;
    private readonly IListarVacunosOutputPort _outputMock;
    ...
    private readonly ListarVacunosInteractor _sut;

    public ListarVacunosInteractorTests()
    {
        _repositoryMock = Substitute.For<IVacunoRepository>();
        _outputMock = Substitute.For<IListarVacunosOutputPort>();
        ...
        _sut = new ListarVacunosInteractor(
            _repositoryMock,
            _outputMock,
            _featuresMock,
            _tenantMock,
    ...
    public async Task Handle_WhenValidCommand_MapsDataAndReturnsOk()
    {
        ...
        // Assert
        await _outputMock.Received(1).Ok(Arg.Is<ListarVacunosOutput>(o =>
            o.PagedData.Total == 1 &&
            o.PagedData.Page == 2 &&
